        ...
        <div className="glass-effect rounded-2xl p-8 shadow-2xl ai-glow animate-scale-in">
          <form onSubmit={handleSubmit} className="flex flex-col space-y-6">
            ...
            <button
              type="submit"
              disabled={!query.trim()}
              className="w-full bg-primary hover:bg-primary-hover disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-medium py-3.5 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 hover:shadow-lg flex items-center justify-center space-x-2 text-base"
            >
